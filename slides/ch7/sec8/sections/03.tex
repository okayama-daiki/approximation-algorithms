		...
		\begin{column}{0.37\textwidth}
			\begin{tikzpicture}
				\begin{axis}[
						...
						ymax=5,
						xtick={0, 1/sqrt(2)},
						xticklabels={0, $\frac{1}{\sqrt{2}}$},
						ytick=\empty,
					]

					\addplot[thick] {1 + 2*x}
					node[pos=0.35, right] {\small{$1 + 2\mu$}};

					\addplot[thick] {1 + 1/x}
					node[pos=0.93, below] {\small{$1 + 1/\mu$}};

					\addplot[thick, densely dashed, line width=1.2pt, color=orange] {max(1 + 2*x, 1 + 1/x) }
					node[pos=0.66, right, orange] {\small{$\max\{1+2\mu,\;1+1/\mu\}$}};
